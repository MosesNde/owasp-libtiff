int PlaceImage(TIFF *tif, FILE *fp, int *npages, uint32 w, uint32 h, double pagewidth, double pageheight, double imagewidth, double imageheight, int splitpage, double lm, double bm, int cnt, int user_role) {
    int i = 0;
    int ximages = 0;
    int splitaxis = 0;
    double xtran = 0;
