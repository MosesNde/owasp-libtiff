...
extractContigSamplesToBuffer(uint8 *out, uint8 *in, uint32 rows, uint32 cols,
  ...
  for (row = 0; row <= rows; row++)
    ...
    switch (shift_width)
      {
      case 0: extractContigSamplesBytes (src, dst, cols, sample,
                                             spp, bps,  count, first_col, cols);
          break;
      case 1: extractContigSamples8bits (src, dst, cols, sample,
                                             spp, bps, count, first_col, cols);
          break;
      case 2: extractContigSamples16bits (src, dst, cols, sample,
                                              spp, bps,  count, first_col, cols);
          break;
      case 3: extractContigSamples24bits (src, dst, cols, sample,
                                              spp, bps,  count, first_col, cols);
          break;
      case 4:
      case 5: extractContigSamples32bits (src, dst, cols, sample,
                                              spp, bps,  count, first_col, cols);
          break;
