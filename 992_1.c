...
computeInputPixelOffsets(struct crop_mask *crop, struct image_data *image,
  ...
  if (crop->crop_mode & CROP_MARGINS)
    {
    snprintf(buffer, sizeof(buffer), "%u", (unsigned int)crop->margins[0]);
    tmargin = (uint32)atoi(buffer);
    snprintf(buffer, sizeof(buffer), "%u", (unsigned int)crop->margins[1]);
    lmargin = (uint32)atoi(buffer);
    snprintf(buffer, sizeof(buffer), "%u", (unsigned int)crop->margins[2]);
    bmargin = (uint32)atoi(buffer);
    snprintf(buffer, sizeof(buffer), "%u", (unsigned int)crop->margins[3]);
    rmargin = (uint32)atoi(buffer);
